 ...
 * 
 * On Thu Feb 22 18:09:09 CET 2024
 * 
 */
...
void MOD_mkVectorDot::init_symbols_0()
{
  ...
  init_symbol(&symbols[31u], "done_all__h3778", SYM_DEF, &DEF_done_all__h3778, 1u);
...
void MOD_mkVectorDot::RL_mult_inputs()
{
  ...
  DEF_x__h4027 = INST_output_res.METH_read();
  DEF_x__h4063 = INST_pos_out.METH_read();
  DEF_x__h4079 = INST_dim.METH_read();
  ...
  DEF_x__h1948 = DEF_x_wget__h1850;
  DEF_v__h3885 = DEF_b_serverAdapter_outData_ff_i_notEmpty____d54 ? DEF_x_first__h1735 : DEF_x__h1948;
  DEF_x__h472 = DEF_x_wget__h374;
  DEF_v__h3785 = DEF_a_serverAdapter_outData_ff_i_notEmpty____d4 ? DEF_x_first__h259 : DEF_x__h472;
  DEF_y__h4028 = (tUInt32)(((tUInt64)(DEF_v__h3785)) * ((tUInt64)(DEF_v__h3885)));
  DEF_pos_out_50_EQ_dim_10_MINUS_1_52___d153 = DEF_x__h4063 == ((tUInt8)255u & (DEF_x__h4079 - (tUInt8)1u));
  DEF_x__h3993 = DEF_x__h4027 + DEF_y__h4028;
  DEF_x__h4044 = (tUInt8)255u & (DEF_x__h4063 + (tUInt8)1u);
  ...
  INST_output_res.METH_write(DEF_x__h3993);
  INST_pos_out.METH_write(DEF_x__h4044);
...
void MOD_mkVectorDot::METH_start(tUInt8 ARG_start_dim_in, tUInt8 ARG_start_i)
{
  tUInt8 DEF_y__h4506;
  tUInt8 DEF_x__h4487;
  DEF_y__h4506 = (tUInt8)255u & ARG_start_i;
  DEF_x__h4487 = (tUInt8)((tUInt8)255u & (65535u & (((tUInt32)(ARG_start_dim_in)) * ((tUInt32)(DEF_y__h4506)))));
  ...
  INST_pos_a.METH_write(DEF_x__h4487);
  INST_pos_b.METH_write(DEF_x__h4487);
...
tUInt8 MOD_mkVectorDot::METH_RDY_response()
{
  ...
  DEF_done_all__h3778 = INST_done_all.METH_read();
  DEF_CAN_FIRE_response = DEF_done_all__h3778;
...
unsigned int MOD_mkVectorDot::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "done_all__h3778", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h4027", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h4079", 8u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
...
void MOD_mkVectorDot::vcd_defs(tVCDDumpType dt, MOD_mkVectorDot &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF_b_serverAdapter_s1___d84 = DEF_b_serverAdapter_s1___d84;
      ...
      ++num;
      if ((backing.DEF_done_all__h3778) != DEF_done_all__h3778)
      {
	vcd_write_val(sim_hdl, num, DEF_done_all__h3778, 1u);
	backing.DEF_done_all__h3778 = DEF_done_all__h3778;
      }
      ++num;
	...
	backing.DEF_x__h3690 = DEF_x__h3690;
      ...
      ++num;
      if ((backing.DEF_x__h4027) != DEF_x__h4027)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h4027, 32u);
	backing.DEF_x__h4027 = DEF_x__h4027;
      }
      ++num;
      if ((backing.DEF_x__h4079) != DEF_x__h4079)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h4079, 8u);
	backing.DEF_x__h4079 = DEF_x__h4079;
      }
      ++num;
